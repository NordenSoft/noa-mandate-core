...
const CLASS_RULES = [
  ...
  [/malleability|low-order pubkey|non-canonical y.q|non-canonical keyring spki|non-canonical pubkey|off-curve pubkey/i, "malleability"],
...
const FILE_VECTOR_CLASS_RULES = [
  ...
  [/malleab|low-order|non-canonical.*(pubkey|spki|point)|off-curve/i, "malleability"],
