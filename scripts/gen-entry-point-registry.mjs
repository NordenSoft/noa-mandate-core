...
const EXEMPT = {
  ...
  projectionIdentityHash: ["UTILITY", "pure pre-image construction (src/deploy-release.ts); no verdict"],
  ...
  DEPLOY_RELEASE_SPEC: ["CONSTANT", ""],
  DEPLOY_RELEASE_CANONICAL: ["CONSTANT", ""],
  DEPLOY_RELEASE_IMPLEMENTATION_DIGEST: ["CONSTANT", ""],
  DEPLOY_RELEASE_SCHEMA_ID: ["CONSTANT", ""],
  DEPLOY_RELEASE_DISPLAY_ID: ["CONSTANT", ""],
  LEDGER_TRANSFER_SPEC: ["CONSTANT", ""],
  LEDGER_TRANSFER_CANONICAL: ["CONSTANT", ""],
  LEDGER_TRANSFER_IMPLEMENTATION_DIGEST: ["CONSTANT", ""],
  LEDGER_TRANSFER_SCHEMA_ID: ["CONSTANT", ""],
  LEDGER_TRANSFER_DISPLAY_ID: ["CONSTANT", ""],
