...
export function hashSecret(secret: string): string {
  ...
  // DoS-resistant. Plaintext credentials are never persisted. A CodeQL js/insufficient-password-hash
  // alert here is dismissed on GitHub with a written reason (this repository's CodeQL setup applies
  // no inline suppression comment).
