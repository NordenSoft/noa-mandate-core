...
export {
  ...
  resolveTrustMode,
  isBootId,
  supervisorBootProblem,
  frozenBeforeBoot,
  MAX_BOOT_START_SKEW_MS,
  type BootIdSource,
...
// The Gate-pin fingerprint (docs/gate-pin-spec.md): a display string, never an authority input.
export {
  GATE_PIN_SPEC,
  GATE_PIN_PREFIX,
  gatePinFingerprint,
  gatePinFingerprintFromRaw,
  gatePinPublicKeyFromRaw,
  type GatePinResult,
  type GatePinKeyResult,
  type GatePinRefusalCode,
  type GatePinRawKeyRefusalCode,
} from "./gate-pin.js";
export {
  GATE_ROSTER_SPEC,
  parseGateRoster,
