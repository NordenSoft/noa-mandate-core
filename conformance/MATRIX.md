...
| `malleability` | PASS (39) | PASS (39) | PASS (14) | PASS (14) | PASS (14) |
...
Total checks in this run — `node impl-py/conformance.mjs`: **171** checks, exit **0** (0 = every check agreed). · `bash impl-go/conformance_test.sh`: **69** checks (61 in the table above, 8 additional), exit **0**. · `bash impl-rust/conformance.sh`: **60** checks (53 in the table above, 7 additional), exit **0**. · `bash impl-csharp/conformance.sh`: **62** checks (54 in the table above, 8 additional), exit **0**.
